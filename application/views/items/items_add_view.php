                            ...
                            <div class="card ">
                                <div class="card-body">
                                    <form method="post" action=" <?= base_url('items/Items/submit_added_item/') ?>" enctype="multipart/form-data">
                                        ...
                                        <div class="form-row pt-4">
                                            <div class="form-group col-md-6 px-4 pr-5">
                                                <label for="">Item Selling Price Per Unit (RM)</label>
                                            ...
                                            <div class="form-group col-md-6 px-4 pr-5">
                                                ...
                                                <div class="input-group-prepend">
                                                    ...
                                                    <input type="number" min="0" class="form-control" id="item_cost_price" name="item_cost_price" step="0.01" placeholder="Enter item price per unit" required>
                                                </div>
                                            </div>
                                        ...
                                        <div class="form-row pt-4">
                                            ...
                                            <div class="form-group col-md-6 px-4 pr-5">
                                                ...
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text" id="basic-addon4">Qty</span>
